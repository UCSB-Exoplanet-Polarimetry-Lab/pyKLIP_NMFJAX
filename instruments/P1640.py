...
class P1640Data(Data):
    ...
    def readdata(self, filepaths):
        ...
        for index, filepath in enumerate(filepaths):
            cube, center, pa, wv, astr_hdrs, filt_band, fpm_band, ppm_band, spot_flux = _p1640_process_file(filepath)
    ...
    def savedata(filepath, data, astr_hdr=None):
        """
        Save data in a P1640-like fashion. Aka, data and header are in the first extension header
