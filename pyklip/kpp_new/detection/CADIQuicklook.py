...
class CADIQuicklook(KPPSuperClass):
    ...
    def initialize(self,inputDir = None,
        ...
        self.filename_sdiSNR = "planet_detec_CADI"+os.path.sep+"default_out"+os.path.sep+"cadi_*_nosdi_hp4-SNR_Dr2rs2.fits"
    ...
    def calculate(self):
        ...
        plt.figure(1,figsize=(8*2,16))
        plt.subplot(2,2,1)
        plt.imshow(self.image_nosdi[::-1,:], interpolation="nearest")#,extent=[x_grid[0,0],x_grid[0,nx-1],y_grid[0,0],y_grid[ny-1,0]])
        plt.subplot(2,2,2)
        plt.imshow(self.image_sdi[::-1,:], interpolation="nearest")#,extent=[x_grid[0,0],x_grid[0,nx-1],y_grid[0,0],y_grid[ny-1,0]])
        plt.subplot(2,2,3)
        plt.imshow(self.image_nosdiSNR[::-1,:], interpolation="nearest")#,extent=[x_grid[0,0],x_grid[0,nx-1],y_grid[0,0],y_grid[ny-1,0]])
        plt.clim(0.,5.0)
        plt.subplot(2,2,4)
        plt.imshow(self.image_sdiSNR[::-1,:], interpolation="nearest")#,extent=[x_grid[0,0],x_grid[0,nx-1],y_grid[0,0],y_grid[ny-1,0]])
        plt.clim(0.,5.0)
        #plt.show()
    ...
    def save(self):
        ...
        #
        #     self.exthdr["QLFNADI"] = self.filename_nosdi_path
        #     self.exthdr["QLFNSDI"] = self.filename_sdi_path
        #     self.exthdr["QLFNASNR"] = self.filename_nosdiSNR_path
        #     self.exthdr["QLFNSSNR"] = self.filename_sdiSNR_path
        #     self.exthdr["QLINDIR"] = self.inputDir
        #     self.exthdr["QLOUTDI"] = self.outputDir
        #     self.exthdr["QLFOLDN"] = self.folderName
        #
        #     self.exthdr["QLGOILF"] = self.GOI_list_folder
        #
        ...
        #
        #     hdulist[1].header["QLFNADI"] = self.filename_nosdi_path
        #     hdulist[1].header["QLFNSDI"] = self.filename_sdi_path
        #     hdulist[1].header["QLFNASNR"] = self.filename_nosdiSNR_path
        #     hdulist[1].header["QLFNSSNR"] = self.filename_sdiSNR_path
        #     hdulist[1].header["QLINDIR"] = self.inputDir
        #     hdulist[1].header["QLOUTDI"] = self.outputDir
        #     hdulist[1].header["QLFOLDN"] = self.folderName
        #
        #     hdulist[1].header["QLGOILF"] = self.GOI_list_folder
        #
        #     hdulist.writeto(self.outputDir+os.path.sep+self.folderName+os.path.sep+self.prefix+'-'+self.suffix+'.fits', clobber=True)
