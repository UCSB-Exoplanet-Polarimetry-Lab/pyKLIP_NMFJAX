...
import time
#include paths to use empca and matutil
#TODO:make empca part of pyklip's own setup and replace matutils with np.linalg
sys.path.append('/home/minghan/CHARIS/charis-work/reduction/')
sys.path.append('/home/minghan/CHARIS/charis-work/reduction/empca/')
import matutils
